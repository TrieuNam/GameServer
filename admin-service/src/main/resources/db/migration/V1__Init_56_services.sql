...
('role-service',       'Role Service',       'P1', 11, 8410, 'D:/project/serverGame/GameServer/role-service/target/role-service-1.0.0.jar',             'D:/project/serverGame/GameServer/role-service',       TRUE, TRUE,  'local-roledb',         '-Xss2m -Xms128m -Xmx256m', 'Character Roles',                'http://localhost:8410/actuator/health'),
...
('bag-service',        'Bag Service',        'P1', 17, 8230, 'D:/project/serverGame/GameServer/bag-service/target/bag-service-1.0.0.jar',               'D:/project/serverGame/GameServer/bag-service',        TRUE, TRUE,  'local-bagdb',          NULL,                        'Inventory Management',           'http://localhost:8230/actuator/health'),
