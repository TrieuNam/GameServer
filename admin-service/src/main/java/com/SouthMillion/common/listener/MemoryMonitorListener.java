...
public class MemoryMonitorListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void logDetailedMemoryUsage() {
        ...
        log.info("════════════════════════════════════════════════");
        log.info("📊 MEMORY USAGE REPORT (After Startup)");
        log.info("════════════════════════════════════════════════");
        log.info("💾 Heap Memory:     {} / {} MB ({}%)",
                 usedHeap, maxHeap,
                 maxHeap > 0 ? (usedHeap * 100 / maxHeap) : -1);
        log.info("💾 Non-Heap:        {} / {} MB ({}%)",
                 usedNonHeap,
        ...
        log.info("📦 Estimated Total: ~{} MB", totalEstimated);
        log.info("════════════════════════════════════════════════");
    }
