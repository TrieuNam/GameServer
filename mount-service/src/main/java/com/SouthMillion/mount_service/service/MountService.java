...
public interface MountService {
    ...
    /**
     * Get active skills for a mount
     * Returns skills that are unlocked based on mount's grade and star level
     */
    List<MountSkill> getActiveSkills(Mount mount);

    /**
     * Get total buff values from all active mount skills
     * Used to calculate party bonuses
     */
    Map<MountSkill.BuffAttribute, Long> getTotalBuffs(Mount mount);
}
