...
public class EquipBagOneInfoHandler implements GameMessageHandler {
    ...
    public void handle(WebSocketSession session, byte[] payload) {
        try {
            ...
            Msgequip.PB_SCEquipBagOneInfo resp = Msgequip.PB_SCEquipBagOneInfo.newBuilder()
                    .setBagData(Msgequip.PB_EquipBagData.newBuilder()
                            .setIndex(d.getEquipType())
                    ...
                    .build();
            sendResponse(session, 1608, resp.toByteArray());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    @Override public int getMsgId() { return 1608; }
}
