...
@Component
public class BoxSetingInfoHandler implements GameMessageHandler {
    public void sendBoxSetingInfo(WebSocketSession session, Msgbox.PB_SCBoxSetingInfo resp) {
    ...
    @Override
    public int getMsgId() { return 1617; }
}