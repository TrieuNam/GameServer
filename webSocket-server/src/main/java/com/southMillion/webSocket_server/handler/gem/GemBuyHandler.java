...
@Component
public class GemBuyHandler implements GameMessageHandler {
    @Autowired
    ...
    public void handle(WebSocketSession session, byte[] payload) {
        ...
        // tuỳ opType, thực hiện thao tác
        // Sau khi thao tác xong, trả lại PB_SCGemInfo như các handler trên:
    ...
    private Long getUserIdFromSession(WebSocketSession session) {
        // Tách userId từ session/attribute
